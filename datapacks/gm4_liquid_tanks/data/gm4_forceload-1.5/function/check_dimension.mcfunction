...
say FORCELOAD check_dimension

advancement revoke @s only gm4_forceload-1.5:dimension_marking
...
execute if score $initialized gm4_dimension matches 0 run function gm4_forceload-1.5:mark_dimension
