...
execute if score $initialized gm4_dimension matches 0 run say FORCELOAD $initialized matches 0
execute if score $initialized gm4_dimension matches 1 run say FORCELOAD $initialized matches 1
execute unless score $initialized gm4_dimension = $initialized gm4_dimension run say FORCELOAD $initialized IS NULL
...
execute if entity @e[type=marker,tag=gm4_new_dimension,limit=1] run say FORCELOAD marker exists
execute unless entity @e[type=marker,tag=gm4_new_dimension,limit=1] run say FORCELOAD marker doesn't exist
